...
class myYOLO(nn.Module):
    def __init__(self, device, input_size=416, num_classes=20, trainable=False, conf_thresh=0.01, nms_thresh=0.5, hr=False):
        ...
        #resnet_out_channel = backbone.fc.in_features
